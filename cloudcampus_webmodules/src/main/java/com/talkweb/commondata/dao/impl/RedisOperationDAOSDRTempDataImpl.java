 ...
 * @date 2015年5月12日
 */
@Repository(value="redisOperationDAOSDRTempDataImpl")
public class RedisOperationDAOSDRTempDataImpl implements RedisOperationDAO {
		
	@Resource(name="redisSentinelTempDataTemplate")
