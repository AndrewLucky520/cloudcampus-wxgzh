...
//		}
	//	System.out.println("------------------------------"+sb.toString());
		...
		for(SeqSubject one:seqSubjects[otherCd][otherSeq-1].values()){
			if((subSubjectCombination.subjectId.equals(subjectId)&&subSubjectCombination.seqIndex.equals(otherSeq))
					||(!subSubjectCombination.subjectId.equals(subjectId)&&!subSubjectCombination.seqIndex.equals(otherSeq))){
				return false;
			}
		}
		return true;
	...
	public static void main1(String[] args){
		Set<List<Integer>> allSeqPerm = CommonUtils.getPermutation(Arrays.asList(new Integer[]{1,2,3}));
		System.out.println(JSONObject.toJSONString(allSeqPerm));
		//		List<Integer>[] subjectIds11 = new List[]{Arrays.asList(new Integer[]{8,9}),Arrays.asList(new Integer[]{7,8})};
//		List<Integer>[] subjectIds12 = new List[]{Arrays.asList(new Integer[]{7,9}),Arrays.asList(new Integer[]{5,7})};
//		List<Integer>[] subjectIds21 = new List[]{Arrays.asList(new Integer[]{7,9}),Arrays.asList(new Integer[]{5,7})};
//		List<Integer>[] subjectIds22 = new List[]{Arrays.asList(new Integer[]{8,9}),Arrays.asList(new Integer[]{7,8})};
//		Conflict c11 = new Conflict(subjectIds11,null);
//		Conflict c12 = new Conflict(subjectIds12,null);
//		Conflict c21 = new Conflict(subjectIds21,null);
//		Conflict c22 = new Conflict(subjectIds22,null);
//		List<Conflict> c1 = new ArrayList();
//		c1.add(c11);
//		c1.add(c12);
//		List<Conflict> c2 = new ArrayList();
//		c2.add(c21);
//		c2.add(c22);
//		
//		//		Integer[][] subjectIds2 = new Integer[][]{{8,9},{7,8}};
////		System.out.println(Arrays.deepEquals(subjectIds1, subjectIds2));
//		
//		Set<List<Conflict>> allConflictsSet = new TreeSet(new Comparator<List<Conflict>>(){
//			@Override
//			public int compare(List<Conflict> o1, List<Conflict> o2) {
//				// TODO Auto-generated method stub
//				ConflictSet o1CsConflictSet  = new ConflictSet();
//				o1CsConflictSet.addAll(o1);
//				ConflictSet o2CsConflictSet  = new ConflictSet();
//				o2CsConflictSet.addAll(o2);
//				o1CsConflictSet.removeAll(o2CsConflictSet);
//				return o1CsConflictSet.size()==0?0:Integer.compare(o1.hashCode(), o2.hashCode());
//			}});
//		allConflictsSet.add(c1);
//		allConflictsSet.add(c2);
//		System.out.println(allConflictsSet.size());
	}
	
	public static void main(String[] args){
		List<Integer> test = Arrays.asList( new Integer[]{6,1,4,2,3,7,0});
		List<Integer> test2 = Arrays.asList( new Integer[]{4,7});
