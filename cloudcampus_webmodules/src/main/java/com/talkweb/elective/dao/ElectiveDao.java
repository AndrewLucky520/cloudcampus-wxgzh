...
public interface ElectiveDao {
    ...
    int deleteElectiveCourseSingle(HashMap<String,Object> map);
    //选修课程设置
    /**获取选修课程*/
    ...
    /**创建选修课程*/
    int createElectiveCourse(HashMap<String,Object> map,List<JSONObject> classList,List<JSONObject> teacherList,List<JSONObject> schoolTimeList);
    /**批量创建选修课程*/
    Map<String,Object> batchInsertElectiveCourse(HashMap<String,Object> map)throws Exception;
    /**获取某个课程的任课教师ids*/
    String getElectiveCourseTeacher(HashMap<String,Object> map);
    /**获取某个课程的班级ids*/
    String getElectiveCourseClass(HashMap<String,Object> map);
    /**修改选修课程*/
    int updateElectiveCourse(HashMap<String,Object> map,List<JSONObject> classList,List<JSONObject> teacherList,List<JSONObject> schoolTimeList);
    /**删除选修课程*/
...
//    int deleteCourseTypeRequire(HashMap<String,Object> map);
    ...
    JSONObject getCourseToExport(HashMap<String,Object> map);
    List<JSONObject> getStudentToExport(HashMap<String,Object> map);
    //课程类别要求设置
    /**获取课程类别要求*/
    ...
    /**新增选课学生*/
    int insertElectiveStudent(List<JSONObject> list);
    /**删除选课学生*/
    int deleteElectiveStudent(HashMap<String,Object> map);
    ...
    //学生选课
    JSONObject getOneCourse(HashMap<String,Object> map);
    /**得到当前选课*/
    ...
    /**为初始化得到班级课程上限**/
    List<JSONObject> getCourseNumForInit(HashMap<String,Object> map);
    List<JSONObject> getSelectedCourseList(HashMap<String,Object> map);
    ...
    //附件图片
	void insertAttachment(JSONObject param);
	void deleteAttachment(JSONObject param);
	List<JSONObject> getAttachment(JSONObject param);
	void updateAttachment(JSONObject param);
	void deleteAttachmentByElectiveId(JSONObject param);
}
