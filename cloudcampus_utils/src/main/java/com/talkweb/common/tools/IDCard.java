 ...
 * @version:1.0
 * @Description: 身份证校验类 含身份证中出生日期提取 性别提取
 * @author 武洋 ---智慧校
 * @date 2015年3月6日
 */
public class IDCard {
     ...
     * @return
     */
    public static String getCsDate(String IDStr){
        String Ai = "";
        // =======================(end)========================
    ...
    public static String getXbm(String IDStr){
        String Ai = "";
        if (IDStr.length() == 18) {
            Ai = IDStr.substring(0, 17);
        } else if (IDStr.length() == 15) {
        ...
        String xbm = "男";
        String xb = Ai.substring(15,17);
        int isXb = Integer.parseInt(xb);
        if(isXb%2==0){
            xbm = "女";
        }
        return xbm;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String rs = cc.IDCardValidate(IDCardNum);
            System.out.println(rs);
            if(rs.equalsIgnoreCase("YES")){
                
                System.out.println(cc.getXbm(IDCardNum));
            }
        }
