            ...
            public int compare(Object obj1, Object obj2) {     
                ...
                try {    
                    ...
                    if (sortMode != null && "desc".equals(sortMode)) {    
                        ...
                        result = Integer.parseInt(  method2.invoke(((T) obj2), null).toString())
                        		>Integer.parseInt(  method1.invoke(((T) obj1), null).toString())?1:-1;
                        if(Integer.parseInt(  method2.invoke(((T) obj2), null).toString())
                        		==Integer.parseInt(  method1.invoke(((T) obj1), null).toString())){
                        	result = 0;
                        }
                    } else {    
                        result = Integer.parseInt(  method2.invoke(((T) obj2), null).toString())
                        		<Integer.parseInt(  method1.invoke(((T) obj1), null).toString())?1:-1;// 正序    
                        if(Integer.parseInt(  method2.invoke(((T) obj2), null).toString())
                        		==Integer.parseInt(  method1.invoke(((T) obj1), null).toString())){
                        	result = 0;
                        }
